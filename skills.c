...
void move(int dis)
{
	...
	if(dis2 > 0){
		while(nMotorEncoder[leftMotor] < dis2)
		{
			motor[leftMotor] = motor[rightMotor] = 127;
		}
	}else{
	while(nMotorEncoder[leftMotor] > -1*dis2)
	{
		motor[leftMotor] = motor[rightMotor] = -127;
	}
}
...
{nMotorEncoder[rightMotor] = nMotorEncoder[lift2] = nMotorEncoder[claw2] = 0;
	while(nMotorEncoder[leftMotor] > -30*360/(4*3.1415926535) || nMotorEncoder[lift2] < 120)
	{
		motor[rightMotor] = motor[leftMotor]= -127;
		motor[lift1] = motor[lift2] = 127;
	}
	while(nMotorEncoder[leftMotor] > -34*360/(4*3.1415926535))
	{
		motor[rightMotor] = motor[leftMotor]= -127;
		motor[lift1] = motor[lift2] = 127;
...
{nMotorEncoder[rightMotor] = nMotorEncoder[lift2] = nMotorEncoder[claw2] = nMotorEncoder [leftMotor] = 0;
...
task autonomous()
{
 nMotorEncoder[leftMotor] = nMotorEncoder[rightMotor] = nMotorEncoder[lift2] = 0;
